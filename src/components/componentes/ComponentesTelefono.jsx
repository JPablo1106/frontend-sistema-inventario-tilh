...
const ComponentesTelefono = () => {
    ...
    const fetchAsignacionesTelefonos = async () => {
        ...
        try {
            ...
            const asignacionesTelefonosArray = Array.isArray(response.data)
                ? response.data
            ...
            Swal.fire({
                title: 'Error',
                text: 'No se pudieron cargar las asignaciones de teléfonos.',error,
                icon: 'error',
    ...
    const filtracionDatos = useMemo(() => {
        ...
        return asignacionesTelefonos.filter((telefono) =>
            telefono.usuario?.nombreUsuario.toLowerCase().includes(busquedaFilt.toLocaleLowerCase()) ||
    ...
    const handleExportExcel = async () => {
        ...
        // Definir columnas y asignar ancho
        ...
        // Aplicar estilos a la cabecera: fondo rojo corporativo, fuente blanca y centrado
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) =>
                    row.original.detalleAsignaciones &&
                    row.original.detalleAsignaciones[0]?.componente?.modeloTelefono || 'sin datos',
            },
            {
                        ...
                        <div className="col-md-6">
                            <div className="input-group">
                                ...
                                <input
                                    ...
                                    placeholder="Buscar teléfonos asignados..."
                                    value={busquedaFilt}
