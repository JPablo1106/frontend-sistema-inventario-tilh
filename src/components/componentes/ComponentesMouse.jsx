...
import { FaSearch, FaPlus, FaFileExcel, FaSync, FaInfoCircle, FaMouse } from "react-icons/fa"
...
const ComponentesMouse = () => {
  ...
  const fetchAsignacionesMouse = async () => {
    ...
    try {
      ...
      const asignacionesMouseArray = Array.isArray(response.data) ? response.data : Object.values(response.data)
      ...
      console.error("Error al obtener asignaciones de mouse:", error)
      setError(true)
      Swal.fire({
        title: "Error de conexión",
        text: "No se pudieron cargar las asignaciones de mouse. Intente nuevamente.",
        icon: "error",
  ...
  const filtracionDatos = useMemo(() => {
    ...
    return asignacionesMouse.filter(
      (mouse) =>
        mouse.usuario?.nombreUsuario.toLowerCase().includes(busquedaFilt.toLowerCase()) ||
        mouse.usuario?.area?.toLowerCase().includes(busquedaFilt.toLowerCase()) ||
        mouse.usuario?.departamento?.toLowerCase().includes(busquedaFilt.toLowerCase()) ||
          ...
          <div className="col-md-6 text-center">
            <div className="card shadow-lg border-0">
              <div className="card-body p-5">
                ...
                <h4 className="mb-3">Cargando datos de mouse</h4>
          ...
          <div className="col-md-6 text-center">
            <div className="card shadow-lg border-0 bg-light">
              <div className="card-body p-5">
                ...
                <p className="text-muted mb-4">No se pudieron cargar los datos de mouse asignados.</p>
                <button className="btn btn-primary" onClick={fetchAsignacionesMouse}>
      ...
      <div className="row mb-4 align-items-center">
        <div className="col-md-6">
          <h2 className="fw-bold text-primary">
            <FaMouse className="me-2" />
            Gestión de Mouse
          </h2>
          <p className="text-muted">Administración de mouse asignados en el sistema de inventario</p>
        </div>
        <div className="col-md-6 text-md-end">
          <button className="btn btn-outline-primary me-2" onClick={fetchAsignacionesMouse}>
          ...
          <div className="card shadow-sm border-0">
            <div className="card-header bg-white d-flex justify-content-between align-items-center py-3">
              <div className="d-flex align-items-center">
                <FaMouse className="text-danger me-2" style={{ fontSize: "1.2rem" }} />
                <h5 className="mb-0">Listado de Mouse Asignados</h5>
              </div>
              <div className="d-flex gap-2">
                ...
                <button className="btn btn-primary btn-sm" onClick={handleAgregarMouse} title="Agregar nuevo mouse">
                      ...
                      <tr>
                        <td colSpan={columns.length} className="text-center py-4">
                          <div className="alert alert-info mb-0">
                            ...
                            No hay mouse asignados para mostrar
                          </div>
                        </td>
                      </tr>
                    )}
      ...
      <div className="row mt-2">
        <div className="col-12">
          <div className="alert alert-info d-flex align-items-center" role="alert">
            <FaInfoCircle className="me-2" />
            <div>
              <strong>Información:</strong> Esta tabla muestra los mouse asignados a usuarios en el sistema. Para
              agregar un nuevo mouse, haga clic en "Nuevo Mouse".
            </div>
          </div>
        </div>
      </div>
