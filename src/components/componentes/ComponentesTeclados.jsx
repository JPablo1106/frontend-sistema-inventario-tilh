...
const ComponentesTeclados = () => {
    ...
    const fetchAsignacionesTeclados = async () => {
        ...
        try {
            ...
            const asignacionesTecladosArray = Array.isArray(response.data)
                ? response.data
            ...
            Swal.fire({
                title: 'Error',
                text: 'No se pudieron cargar las asignaciones de teclados.',error,
                icon: 'error',
    ...
    const filtracionDatos = useMemo(() => {
        ...
        return asignacionesTeclados.filter((teclado) =>
            teclado.usuario?.nombreUsuario.toLowerCase().includes(busquedaFilt.toLocaleLowerCase()) ||
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) =>
                    row.original.detalleAsignaciones &&
                    row.original.detalleAsignaciones[0]?.componente?.idiomaTeclado || "sin datos",
            },
            {
                        ...
                        <div className="col-md-6">
                            <div className="input-group">
                                ...
                                <input
                                    ...
                                    placeholder="Buscar teclados asignados..."
                                    value={busquedaFilt}
