...
const ComponentesMonitores = () => {
    ...
    const fetchAsignacionesMonitores = async () => {
        ...
        try {
            ...
            const asignacionesMonitoresArray = Array.isArray(response.data)
                ? response.data
            ...
            Swal.fire({
                title: 'Error',
                text: 'No se pudieron cargar las asignaciones de monitores.', error,
                icon: 'error',
    ...
    const filtracionDatos = useMemo(() => {
        ...
        return asignacionesMonitores.filter((monitor) =>
            monitor.usuario?.nombreUsuario.toLowerCase().includes(busquedaFilt.toLocaleLowerCase()) ||
    ...
    const handleExportExcel = async () => {
        ...
        // Estilos de cabecera (ej. fondo rojo corporativo y fuente blanca)
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) =>
                    row.original.detalleAsignaciones &&
                    row.original.detalleAsignaciones[0]?.componente?.modeloMonitor || 'sin datos',
            },
            {
                        ...
                        <div className="col-md-6">
                            <div className="input-group">
                                ...
                                <input
                                    ...
                                    placeholder="Buscar monitores asignados..."
                                    value={busquedaFilt}
