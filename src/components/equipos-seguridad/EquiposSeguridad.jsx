...
const EquiposSeguridad = () => {
  ...
  const filtracionDatos = useMemo(() => {
    ...
    return asignacionesEquiposSeguridad.filter((equipoSeguridad) =>
  ...
  const handleExportExcel = async () => {
    ...
    const exportData = filtracionDatos.map((item) => {
      ...
      if (item.fechaAsignacion) {
        ...
        fechaAsignacion = `${String(date.getDate()).padStart(2, "0")}-${String(
          date.getMonth() + 1
    ...
    // Aplicar estilos a la cabecera (fondo corporativo, fuente blanca, centrado)
    ...
    <div className="container-container">
      ...
      <div className="card shadow-sm border-0">
        <div className="card-header bg-warning text-white d-flex justify-content-between align-items-center">
          <h4 className="mb-0">Equipos de Seguridad Asignados</h4>
          <div className="d-flex gap-2">
            <button className="btn btn-light btn-sm" onClick={handleExportExcel}>
              <FaFileExcel className="me-1" /> Exportar a Excel
            </button>
            <button className="btn btn-light btn-sm" onClick={handleAgregarEquipoSeguridad}>
            ...
            <div className="col-md-6">
              <div className="input-group">
                ...
                <input
                  ...
                  placeholder="Buscar equipos de seguridad asignados..."
                  value={busquedaFilt}
